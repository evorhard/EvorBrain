    ...
    <div class="p-8 space-y-8 max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A comprehensive collection of form and UI components built with Kobalte and our theme system.
          </CardDescription>
        </CardHeader>
      </Card>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="pt-4 space-y-2">
            <p class="text-sm text-content-secondary">
              Terms agreed: <span class="font-medium text-content">{agreed() ? "Yes" : "No"}</span>
            </p>
            <p class="text-sm text-content-secondary">
              Notifications: <span class="font-medium text-content">{notifications() ? "Enabled" : "Disabled"}</span>
            </p>
          </div>
        </CardContent>
      </Card>
              ...
              <ModalContent size="lg">
                ...
                <div class="py-4">
                  <p class="text-content">
                    This is a large modal that can contain more complex content,
                    forms, or detailed information about your project.
                  </p>
                </div>
                <ModalFooter>
                  <Button>Close</Button>
      ...
      {/* Card Variants */}
      <div class="space-y-4">
        <h2 class="text-2xl font-bold text-content">Card Variants</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <p class="text-sm text-content">
                This is the default card style with shadow.
              </p>
            </CardContent>
          </Card>
          ...
          <Card variant="outline">
            ...
            <CardContent>
              <p class="text-sm text-content">
                A simpler card with just a border.
              </p>
            </CardContent>
          </Card>
          ...
          <Card variant="ghost">
            ...
            <CardContent>
              <p class="text-sm text-content">
                Minimal card style for subtle content.
              </p>
            </CardContent>
          </Card>
        </div>
