...
const textareaVariants = cva(
  "flex min-h-[80px] w-full rounded-md border bg-transparent px-3 py-2 text-sm transition-colors placeholder:text-content-tertiary focus-ring disabled:cursor-not-allowed disabled:opacity-50 resize-none",
  {
    variants: {
      variant: {
