...
describe('TauriMock', () => {
  ...
  describe('Basic functionality', () => {
    ...
    it('should fail on unknown commands when configured', async () => {
      ...
      await expect(mock.getMock()('unknown_command')).rejects.toThrow('Unknown Tauri command: unknown_command');
    });
  ...
  describe('Command handlers', () => {
    it('should handle one-time commands', async () => {
      ...
      await expect(mock.getMock()('once_command')).rejects.toThrow('Command once_command called more than once');
    });
