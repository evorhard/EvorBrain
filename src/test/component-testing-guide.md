...
> **Note**: This guide covers the technical aspects of testing components. For documentation
> standards and requirements, see [Component Documentation Standards](/docs/COMPONENT_STANDARDS.md).
