    ...
    extend: {
      ...
      colors: {
        ...
        priority: {
          ...
          urgent: 'rgb(var(--color-priority-urgent) / <alpha-value>)',
        },
        // Life area colors
        'life-area': {
          personal: 'rgb(var(--color-life-area-personal) / <alpha-value>)',
          work: 'rgb(var(--color-life-area-work) / <alpha-value>)',
          health: 'rgb(var(--color-life-area-health) / <alpha-value>)',
          relationships: 'rgb(var(--color-life-area-relationships) / <alpha-value>)',
          finance: 'rgb(var(--color-life-area-finance) / <alpha-value>)',
          growth: 'rgb(var(--color-life-area-growth) / <alpha-value>)',
        },
      },
      fontFamily: {
